...
export const deleteAffair = (affairs: AffairType[], affairId: number): AffairType[] => {
    console.log('Off')
    return affairs.filter(a => a._id !== affairId)
}
...
function HW2() {
    ...
    const deleteAffairCallback = (affairId: number) => {
        setAffairs(deleteAffair(filteredAffairs, affairId))
    }
